<template>
  ...
  <div class="btnOrder" v-if="empleadosGuardados.length > 0"> 
    <input type="button" value="Ordenar por nombre" @click="ordenarPorNombre" class="btn"/> 
    <input type="button" value="Ordenar por edad" @click="ordenarPorEdad" class="btn"/>
    <input type="button" value="Ordenar por ID" @click="ordenarPorID" class="btn"/>
    <input type="button" value="Ordenar por Experiencia" @click="ordenarPorExp" class="btn"/>
  </div>
