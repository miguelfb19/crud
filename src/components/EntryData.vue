...
export default {
  ...
  methods: {
    guardarDatos() {
      ...
      setTimeout(()=>{this.submitted=false}, 2000) //quito el mensaje de exito despues de 2s
    ...
    actualizarInterfaz() { //para actualizar las vistas y mostrarlos en tabla debo crear un array en data() que me va a guardar las keys de los JSON
